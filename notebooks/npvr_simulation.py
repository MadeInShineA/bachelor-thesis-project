...
def _(mo):
    mo.md(r"""
    Please note that this code was generated by Opencode (Kimi K 2.7 Code)
    """)
    return
...
def _(distribution_fig, mo, npvr_variation_fig, num_variation_fig):
    mo.vstack(
        [
            ...
            mo.md("Low vs. high numerical variability around each sample mean."),
            distribution_fig,
            mo.md("---"),
            mo.md("### NPVR in σ_num / σ_pop space"),
            mo.md(
                "Group A (low numerical variability) and Group B (high numerical "
                "variability) shown as crosses on the NPVR contour map."
            ),
            num_variation_fig,
            mo.md("---"),
            mo.md("### NPVR, sample size and Cohen's d"),
            mo.md(
                "Cohen's d variability as a function of sample size and the "
