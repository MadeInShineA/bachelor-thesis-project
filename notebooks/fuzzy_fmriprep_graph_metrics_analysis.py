...
@app.cell
def _(CONFOUND_COLUMNS, preset, rerun_checkbox):
...
@app.function
def plot_thresholds(thresholded_data: dict, figures_output_path) -> dict:
    for threshold, entries in thresholded_data.items():
...
def _(figures_output_path, thresholded_data):
    plot_thresholds(thresholded_data, figures_output_path)
    return
...
@app.cell
def _(figures_output_path, graph_metrics):
